...
/**
 * Model of a DC motorcontroller rotating a shaft.  All parameters refer to the output (e.g. should already consider gearing
 * and efficiency losses).  The motorcontroller is assumed to be symmetric forward/reverse.
 */
